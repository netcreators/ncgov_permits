...
class Permit extends Base
{
    ...
    public function loadDepublishablePermits()
    {
        ...
        $where = $this->database->getWhere(
            array( // combine with AND
                ...
                '(' . $this->database->getWhere(
                    array( // combine with OR
    ...
    protected function _getField_getObjectAddresses()
    {
        ...
        $this->database->clear();
        $records = $this->database->getQueryRecords(
            $this->controller->extKeyShort . '_addresses',
            $fields,
            $where,
            $groupBy,
    ...
    protected function _getField_getLots()
    {
        ...
        $this->database->clear();
        $records = $this->database->getQueryRecords(
            $this->controller->extKeyShort . '_lots',
            $fields,
            $where,
            $groupBy,
            $orderBy
    ...
    protected function _getField_getCoordinates()
    {
        ...
        $this->database->clear();
        $records = $this->database->getQueryRecords(
            $this->controller->extKeyShort . '_coordinates',
            $fields,
            $where,
            $groupBy,
            $orderBy
    ...
    protected function _getField_getPublications()
    {
        ...
        $publicationsStorageFolder = MathUtility::canBeInterpretedAsInteger(
        ...
        $this->database->clear();
        $records = $this->database->getQueryRecords(
            $this->controller->extKeyShort . '_permits',
            $fields,
            $where,
            $groupBy,
            $orderBy
