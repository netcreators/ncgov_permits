...
class GetMainFieldsHook
{
    ...
    protected function addFieldsAndMakePhaseNotRequired($table)
    {
        ...
        $GLOBALS['TCA'][$table]['types']['1']['showitem'] = str_replace(
            'link,',
            'link, phase, termtype,',
    ...
    {
        $GLOBALS['TCA'][$this->table]['types']['1']['showitem'] = str_replace(
            'objectaddresses,',
            'objectaddresses,coordinates,',
            $GLOBALS['TCA'][$this->table]['types']['1']['showitem']
        );
    }
}
