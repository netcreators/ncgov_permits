...
class ProcessDatamapHook {
	 ...
	 * @param array &$values
	 */
	protected function processDatamap_afterDatabaseOperationsForPermit($table, $id, DataHandler $dataHandler, array &$tsconfig, array &$values) {
	 ...
	 * @param array &$values
	 */
	protected function processDatamap_afterDatabaseOperationsForPublication($table, $id, array &$tsconfig, array &$values) {
