    ...
    'columns' => array(
        ...
        'type' => array(
            ...
            'config' => array(
                ...
                'items' => array(
                    array(
                        'LLL:EXT:' . $_EXTKEY . '/Resources/Private/Language/locallang_tca.xml:' . $_TABLENAME . '.type.I.0',
                        '0'
                    ),
                    array(
                        'LLL:EXT:' . $_EXTKEY . '/Resources/Private/Language/locallang_tca.xml:' . $_TABLENAME . '.type.I.1',
                        '1'
                    ),
                    array(
                        'LLL:EXT:' . $_EXTKEY . '/Resources/Private/Language/locallang_tca.xml:' . $_TABLENAME . '.type.I.2',
                        '2'
                    ),
                ),
                'default' => '2',
        ...
        'phase' => array(
            ...
            'config' => array(
                ...
                'items' => array(
                    array(
                        'LLL:EXT:' . $_EXTKEY . '/Resources/Private/Language/locallang_tca.xml:' . $_TABLENAME . '.phase.I.0',
                        ''
                    ),
                ),
                'multiple' => false,
        ...
        'termtype' => array(
            ...
            'config' => array(
                ...
                'items' => array(
                    array(
                        'LLL:EXT:' . $_EXTKEY . '/Resources/Private/Language/locallang_tca.xml:' . $_TABLENAME . '.termtype.I.0',
                        ''
                    ),
                ),
                'multiple' => false,
